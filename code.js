...
function updateCountdown() {
  ...
  if (keys.length == 0) {
    ...
    keys.forEach(function (game) {
      ...
      var gameHtmlString = `<div class="row"><div class="col"><h2>${gameName}</h2><h3>Day Resets At: ${drHours}:${drMinutes}:${drSeconds}<br />In ${drTillHours}:${drTillMinutes}:${drTillSeconds}</h3></div><div class="col">`;
