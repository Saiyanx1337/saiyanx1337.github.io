...
function updateCountdown() {
  ...
  if (keys.length == 0) {
    ...
    keys.forEach(function (game) {
      ...
      var gameHtmlString = `<div class="row"><div class="col"><h2>${gameName}</h2><h5>Day Resets At (US Central): ${drHours}:${drMinutes}:${drSeconds}<br />In (For UTC+8) ${drTillHours}:${drTillMinutes}:${drTillSeconds}</h5></div><div class="col">`;
