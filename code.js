...
function updateCountdown() {
  ...
  if (keys.length == 0) {
    ...
    keys.forEach(function (game) {
      ...
      var gameHtmlString = `<div class="row"><div class="col"><h2>${gameName}</h2><h6>Day Resets At: ${drHours}:${drMinutes}:${drSeconds}<br />In ${drTillHours}:${drTillMinutes}:${drTillSeconds}</h6></div><div class="col">`;
